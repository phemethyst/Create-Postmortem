 ...
 * or remove the override and add assets/postmortem/textures/item/name.png.
 */
public class AllItems {

    public static final ItemEntry<Item> EXAMPLE_ITEM = CreatePOSTMORTEM.REGISTRATE
            .item("postmortem_item", Item::new)
     ...
     */
    public static final ItemEntry<Item> EXAMPLE_RESULT = CreatePOSTMORTEM.REGISTRATE
            .item("postmortem_result", Item::new)
     ...
     */
    public static final ItemEntry<Item> INCOMPLETE_EXAMPLE = CreatePOSTMORTEM.REGISTRATE
