...
import org.phemethyst.postmortem.content.kinetics.CreatePOSTMORTEMGeneratorBlock;
import org.phemethyst.postmortem.content.kinetics.CreatePOSTMORTEMKineticBlock;
...
public class AllBlocks {
     ...
     */
    public static final BlockEntry<CreatePOSTMORTEMKineticBlock> EXAMPLE_KINETIC_BLOCK = CreatePOSTMORTEM.REGISTRATE
            .block("postmortem_kinetic_block", CreatePOSTMORTEMKineticBlock::new)
     ...
     * registered in CreatePOSTMORTEM. The transform call attaches the EXAMPLE_SOURCE display
     * source to this block.
     */
    public static final BlockEntry<CreatePOSTMORTEMGeneratorBlock> EXAMPLE_GENERATOR_BLOCK = CreatePOSTMORTEM.REGISTRATE
            .block("postmortem_generator_block", CreatePOSTMORTEMGeneratorBlock::new)
     ...
     * axis so the shaft rendered by CreatePOSTMORTEMShaftRenderer visibly pokes out of both ends.
