...
public class CreatePOSTMORTEMPonderScenes {

    /**
     * Storyboard for the postmortem_ponder.nbt schematic: a 5x5 andesite base plate (layer 0)
    ...
    public static void examplePonder(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        // (ponder.postmortem.postmortem_ponder.*), so keep it matching the storyboard id.
        scene.title("postmortem_ponder", "Welcome to the Example Addon");
        ...
        // schematic-local, matching the coordinates baked into postmortem_ponder.nbt.
        ...
        scene.overlay().showText(70)
                .text("Every block here is loaded from postmortem_ponder.nbt")
                .independent(10);
        scene.idle(80);
